...
//        mDemuxerConfig.path = Environment.getExternalStorageDirectory().getPath() + "/2.mp4";
        AssetFileDescriptor assetFileDescriptor = getResources().openRawResourceFd(R.raw.test);
        mDemuxerConfig.afd = assetFileDescriptor;
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mDemuxer == null){
                    ...
                    Log.d("KFDemuxer", "nextBuffer: "+nextBuffer);
                    ///< 循环读取音频帧进入解码器
